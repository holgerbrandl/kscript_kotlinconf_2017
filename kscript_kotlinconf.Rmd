...
cool to meet people involved from the kotlin community in person.
...
techable: less than ptyhon or r , but better tooling
...
...let me give you one example so that we can develop a better feeling about it works
...
use the remaining limits to outline future directions of kscript and the use of kotlin as a language for data scicen
